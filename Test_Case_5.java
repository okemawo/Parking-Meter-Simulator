/**This is a class for test case 7
 *
 *
...
public class Test_Case_5
{
    public static void test_case()
    {
        ...
        ParkedCar car1 = new ParkedCar("TOYOTA", "Hilux", Color.BLACK, "XABZNIG123", 60);
        PoliceOfficer p1 = new PoliceOfficer();
        ParkingTicket ticket = p1.issueTicket(car1, M1);

        // Test Case
        if((ticket.get_car().get_minutes_Parked() - ticket.get_meter().get_parking_Time_Purchased()) == 0)
        {
